...
class PermissionUtil{
    ...
    public static $COMMENTBOX_C='COMMENTBOX_C';
    public static $COMMENTBOX_R='COMMENTBOX_R';
    public static $COMMENTBOX_U='COMMENTBOX_U';
    public static $COMMENTBOX_D='COMMENTBOX_D';

    public static $SURVEYQUESTION_C='SURVEYQUESTION_C';
    public static $SURVEYQUESTION_R='SURVEYQUESTION_R';
    public static $SURVEYQUESTION_U='SURVEYQUESTION_U';
    public static $SURVEYQUESTION_D='SURVEYQUESTION_D';

    public static $SURVEYQUESTIONTYPE_C='SURVEYQUESTIONTYPE_C';
    public static $SURVEYQUESTIONTYPE_R='SURVEYQUESTIONTYPE_R';
    public static $SURVEYQUESTIONTYPE_U='SURVEYQUESTIONTYPE_U';
    public static $SURVEYQUESTIONTYPE_D='SURVEYQUESTIONTYPE_D';
...
class PageUtil{
    ...
    public static $SURVEYQUESTION= 'surveyquestion.php';
    public static $SURVEYQUESTIONTYPE='questiontype.php';
    public static $COMMENTBOX='commentbox.php';
...
class RouteUtil{
    ...
    private function RouteUtil(){
        ...
        //add new page and routing address here always
         ...
         self::$s_Routes[PageUtil::$SURVEY]            =   "/modules/dash/view.survey.php";
         self::$s_Routes[PageUtil::$SURVEYQUESTION] =   "/modules/dash/view.serveyquestion.php";
         self::$s_Routes[PageUtil::$SURVEYQUESTIONTYPE] =   "/modules/dash/view.questiontype.php";
         self::$s_Routes[PageUtil::$COMMENTBOX] =   "/modules/dash/view.commentbox.php";
