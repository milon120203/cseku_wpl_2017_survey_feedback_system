...
class QuestionDAO2{
    ...
    public function getNumOfQue($sID){
        $sql = "select TotalQuestions from tbl_survey where ID = '{$sID}'";
    ...
    public function createQuestion($QuestionOb){
        ...
        $sql = "insert into  tbl_survey_question(ID, SurveyID, QuestionNo, QuestionType, QuestionValue, NumberOfOption) VALUES ('$qID','$surID','$qNO','$qType','$qVal','$noOp')";
    ...
    public function createQuestionOption($queOpt){
        ...
        $sql = "insert into tbl_survey_question_option(ID, SurveyID, QuestionID, OptionFieldValue) VALUES ('$id','$surID','$queID','$optVal')";
    ...
    public function getSurveyTitle($sID){
        $this->_DB->doQuery("select Title from tbl_survey where ID='$sID'");
    ...
    public function getAllQuestions($sID){
        ...
        $questionList = array();
        $this->_DB->doQuery("select * from tbl_survey_question where SurveyID='$sID'");
    ...
    public function getAllOption($sID,$qID){
        ...
        $optionList = array();
        $this->_DB->doQuery("select * from tbl_survey_question_option where SurveyID='$sID' and QuestionID='$qID'");
    ...
    public function createSurveyQuestionFilled($filledData){
        ...
        $sql = "insert into tbl_survey_question_filled(SurveyID, QuestionID, FilledValue, FilledUserID, FilledTime) value('$sID','$qID','$val','$uID','$time')";
